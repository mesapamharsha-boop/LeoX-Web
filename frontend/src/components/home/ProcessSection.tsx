...
import { MessageSquare, Layers, CalendarCheck, Camera, Sparkles } from 'lucide-react';
...
export const ProcessSection: React.FC = () => {
  const steps = [
    ...
    },
    {
      ...
      desc: 'Select from our specialized Photography, Videography, or Viral Reel packages — or craft a bespoke hybrid plan.',
      icon: Layers,
    },
    {
      num: '03',
      title: 'CONFIRM YOUR DATE',
      desc: 'Lock in your schedule with our production calendar. We pre-plan lens choices, shot lists, and lighting setups.',
      icon: CalendarCheck,
    },
    {
      num: '04',
      title: 'WE CAPTURE IT',
      desc: 'Our crew operates unobtrusively with cinema rigs, capturing organic laughter, grand rituals, and energy.',
      icon: Camera,
    },
    {
      num: '05',
