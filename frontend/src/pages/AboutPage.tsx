      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="mt-4 text-lg text-gray-300 leading-relaxed font-normal">
            Visual director, lead cinematographer, and the creative engine behind LEOX. Bringing high-energy, cinematic storytelling to contemporary celebrations across India.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          <div className="lg:col-span-6 relative rounded-2xl overflow-hidden aspect-[4/5] bg-[#12131b] border border-[#222432] shadow-2xl">
            <img
              ...
              alt="Mesapam Sri Harsha - LEOX Founder"
            ...
            <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-black/70 backdrop-blur-md border border-white/10">
              ...
              <div className="text-sm font-heading font-bold text-white mt-0.5">Mesapam Sri Harsha</div>
          ...
          <div className="lg:col-span-6 space-y-6 text-gray-300 leading-relaxed">
            ...
            <p>
              Growing up with an obsession for dynamic visual framing and musical timing, Harsha founded <strong className="text-white">LEOX</strong> with a clear vision: eliminate traditional, static video capture that gathers dust on hard drives.
            </p>
            <p>
            ...
            <p>
              Under Harsha's direction, LEOX has covered high-profile luxury weddings, electronic music festivals with thousands of attendees, and exclusive automobile product launches.
            </p>
