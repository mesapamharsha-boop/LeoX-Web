...
import { Play, Instagram, Eye, MapPin, Calendar, ExternalLink } from 'lucide-react';
...
export const ReelsPage: React.FC<ReelsPageProps> = ({ reels, navigate }) => {
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base sm:text-lg text-gray-300 leading-relaxed font-normal">
              Engineered exclusively for mobile vertical viewing. Dynamic rhythmic edits, custom color grading, and viral trend pacing.
            </p>
          </div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white text-xs font-bold uppercase tracking-wider shadow-xl hover:opacity-90 transition-opacity"
          >
            <Instagram className="w-4 h-4" />
            <span>Visit @leox_shoots</span>
          </a>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 sm:gap-6">
          {reels.map((reel) => (
            <div
              ...
              className="group relative rounded-2xl overflow-hidden bg-[#111217] border border-[#222432] hover:border-[#E50914] transition-all duration-300 flex flex-col aspect-[9/16] shadow-2xl hover:-translate-y-2 cursor-pointer"
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2 text-center">
              <div className="text-xs text-[#E50914] font-bold uppercase tracking-wider">
                {activeReel.eventName} &bull; {activeReel.city} ({activeReel.eventDate})
              </div>
