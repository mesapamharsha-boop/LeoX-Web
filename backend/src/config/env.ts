...
export const ENV = {
  ...
  NOTIFICATION_EMAIL: process.env.CONTACT_EMAIL || process.env.NOTIFICATION_EMAIL || 'mesapamharsha@gmail.com',
  ...
  CONTACT_EMAIL: process.env.CONTACT_EMAIL || process.env.NOTIFICATION_EMAIL || 'mesapamharsha@gmail.com',
