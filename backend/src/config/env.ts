...
export const ENV = {
  ...
  ADMIN_EMAIL: (process.env.ADMIN_EMAIL || 'admin@leox').toLowerCase(),
  ...
  EMAIL_USER: process.env.SMTP_USER || process.env.EMAIL_USER || 'leoxshoots@gmail.com',
  ...
  SMTP_USER: process.env.SMTP_USER || process.env.EMAIL_USER || 'leoxshoots@gmail.com',
