...
export async function seedDatabase() {
  ...
  if (existingServices.length === 0) {
    const initialServices = [
      ...
      },
      {
        ...
        description: 'Cinematic stills capturing raw emotion, candid unscripted glances, and grand atmosphere. Shot with high-resolution Sony Alpha / FX full-frame systems.',
  ...
  if (existingPackages.length === 0) {
    const initialPackages = [
      {
        packageName: 'REEL STARTER',
        slug: 'reel-starter',
        description: 'Ideal for single-event highlights, birthday bashes, corporate launches, and rapid social media updates.',
        price: '₹18,000',
        duration: 'Up to 4 Hours On-Site',
        includedServices: [
          '1 Dedicated Vertical Reel Creator',
          '3 High-Energy Edited Reels (9:16)',
          '24-Hour Express Turnaround',
          'Trending Audio & Color Grading',
          'Exported in 4K 60FPS',
        ],
        featured: false,
        popular: false,
        published: true,
      ...
      {
        packageName: 'REEL PRO',
        slug: 'reel-pro',
        description: 'Our most sought-after short-form package for high-profile parties, concerts, fashion exhibits, and multi-session events.',
        price: '₹35,000',
        duration: 'Up to 8 Hours On-Site',
        includedServices: [
          '1 Senior Reel Videographer + Assistant',
          '6 Cinematic Reels + 1 Teaser Story',
          'Same-Day First Cut Delivery',
          'Advanced Speed Ramping & Sound FX',
          'Behind-The-Scenes Raw Content Dump',
          'Drone Clip Insertions (Where permitted)',
        ],
        featured: true,
        popular: true,
        published: true,
      ...
      {
        packageName: 'EVENT ESSENTIAL',
        slug: 'event-essential',
        description: 'The balanced hybrid package providing stunning still photography plus viral short-form reel coverage.',
        price: '₹45,000',
        duration: 'Full Day Coverage',
        includedServices: [
          '1 Candid Photographer + 1 Reel Creator',
          '150+ Master Edited High-Resolution Photos',
          '4 Viral Instagram Reels',
          'Private Cloud Gallery (1 Year Hosting)',
      ...
      },
      {
        ...
        slug: 'event-premium',
        description: 'Elite cinematic production for weddings, gala concerts, and multi-day celebrations demanding top-tier cameras and drone footage.',
        price: '₹85,000',
        duration: 'Full Event Coverage (12 Hours)',
        includedServices: [
          'Full Production Crew (2 Photographers, 2 Videographers)',
          '4K Cinema Line Highlight Film (3-5 Minutes)',
          '8 Instagram Reels with Custom Typography',
          '350+ Retouched Photos + Full Unedited RAWs',
          'Licensed Drone Aerial Cinematography',
          'Luxury Acrylic Photo Keepsake Box',
        ],
        featured: false,
        popular: false,
        published: true,
      ...
      {
        packageName: 'CUSTOM CINEMATIC',
        slug: 'custom-cinematic',
        description: 'Bespoke custom package tailored for destination weddings, multi-city tours, and luxury brand commercial campaigns.',
        price: 'Custom Quote',
        duration: 'Flexible Multi-Day Timeline',
        includedServices: [
          'Custom Crew Scale & Camera Rig Specification',
          'Worldwide Travel Availability',
          'Live Social Media Broadcasting Support',
          'Executive Producer Consultation',
          'Dedicated Fast-Track Editor',
        ],
        featured: false,
        popular: false,
        published: true,
  ...
  if (existingReels.length === 0) {
    const initialReels = [
      ...
      },
      {
        ...
        description: 'Instant hype reel captured on Sony FX3 with speed ramp transitions at main stage.',
    ...
    const sampleBookings = [
      {
        ...
        internalNotes: 'Advance deposit received. Prime gear assigned: 2x FX3, 70-200mm f2.8 GM.',
      },
      {
